"""Код класса Logger, который используется на данном уроке.Само видео находится в шаге №2
(не  в следующем уроке)"""
...
class Logger():
    file_name = f"C:\\Users\\Diana\\PycharmProjects\\main_project\\logs\\log_" + str(
